...
http://sub2.cutecloud.net/link/2so0o4SjBqEvlyUV?clash=1
http://sub2.cutecloud.net/link/ROoBK7HlfbiQl7Av?clash=1
`

let urls = [];
let subconverter = "sub.zsfan.us.kg"; //在线订阅转换后端，目前使用CM的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
